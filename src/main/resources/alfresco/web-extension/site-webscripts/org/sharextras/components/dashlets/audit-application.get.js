...
function getUserHasViewPermission(username)
{
    return user.isAdmin || (page.url.templateArgs.site != null && getUserIsSiteManager(username));
}

function main()
{
    model.userHasViewPermission = getUserHasViewPermission(user.name);
